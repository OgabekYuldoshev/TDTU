    ...
    return (
        <div className='relative group w-full hover:bg-white p-2 h-fit rounded hover:shadow-lg duration-300'>
            ...
            <div className='w-full mt-2'>
                <h2 className='text-center text-xl font-bold mb-0'>{get(item, `name_${i18n.language}`)}</h2>
                <p className='text-center text-sm mb-0'>{get(item, `position_${i18n.language}`)}</p>
            </div>
        </div>
    )
}
